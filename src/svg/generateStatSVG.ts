            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    ...
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/${acSubmissionNum[0].count}</span></div>
            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    ...
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/${acSubmissionNum[2].count}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    ...
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/${acSubmissionNum[3].count}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
