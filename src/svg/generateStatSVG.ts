...
export const generateStatSVG = (
  ...
  *,
  ...
  .\[\&\:has\(\>\.day-range-end\)\]\:rounded-r-sd-md:has(>.day-range-end) {
    border-bottom-right-radius:var(--sd-radius);
    border-top-right-radius:var(--sd-radius)
  }
  .\[\&\:has\(\>\.day-range-start\)\]\:rounded-l-sd-md:has(>.day-range-start) {
    border-bottom-left-radius:var(--sd-radius);
    border-top-left-radius:var(--sd-radius)
  }
  .\[\&\:has\(\[aria-selected\]\)\]\:rounded-sd-md:has([aria-selected]) {
    border-radius:var(--sd-radius)
  }
  .\[\&\:has\(\[aria-selected\]\)\]\:bg-sd-accent:has([aria-selected]) {
    background-color:hsl(var(--sd-accent))
  }
  .first\:\[\&\:has\(\[aria-selected\]\)\]\:rounded-l-sd-md:has([aria-selected]):first-child {
    border-bottom-left-radius:var(--sd-radius);
    border-top-left-radius:var(--sd-radius)
  }
  .last\:\[\&\:has\(\[aria-selected\]\)\]\:rounded-r-sd-md:has([aria-selected]):last-child {
    border-bottom-right-radius:var(--sd-radius);
    border-top-right-radius:var(--sd-radius)
  }
  .\[\&\:has\(\[data-state\=checked\]\)\]\:border-sd-primary:has([data-state=checked]) {
    border-color:hsl(var(--sd-primary))
  }
  ...
  .\[\&\>h5\]\:text-sd-destructive>h5 {
    color:hsl(var(--sd-destructive))
  }
  .\[\&\>h5\]\:text-sd-foreground>h5 {
    color:hsl(var(--sd-foreground))
  }
  ...
  .\[\&\>svg\]\:text-sd-destructive>svg {
    color:hsl(var(--sd-destructive))
  }
  .\[\&\>svg\]\:text-sd-foreground>svg {
    color:hsl(var(--sd-foreground))
  }
  .\[\&\>svg\~\*\]\:pl-7>svg~* {
    padding-left:1.75rem
  ...
  .\[\&\[data-state\=open\]\>svg\]\:rotate-180[data-state=open]>svg,
  .\[\&\[data-state\=open\]_svg\]\:rotate-45[data-state=open] svg {
    transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
  }
  .\[\&\[data-state\=open\]_svg\]\:rotate-45[data-state=open] svg {
    --tw-rotate:45deg
  }
  .\[\&_\.rc-cascader-menu\]\:w-\[160px\] .rc-cascader-menu {
    width:160px
  }
  ...
  .\[\&_\[cmdk-group-heading\]\]\:text-sd-muted-foreground [cmdk-group-heading] {
    color:hsl(var(--sd-muted-foreground))
  }
  ...
  .\[\&_span\]\:hover\:text-label-4:hover span,
  .\[\&_span\]\:text-label-4 span {
    color:#3c3c434d
  }
  :is(.dark .\[\&_span\]\:dark\:text-dark-label-4) span {
    color:#ebebf54d
  }
  :is(.dark .\[\&_span\]\:dark\:hover\:text-dark-label-4:hover) span {
    color:#ebebf54d
  }
