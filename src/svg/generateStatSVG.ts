...
export const generateStatSVG = (
  ...
  <style>
    ...
    *,
    ...
    .bg-green-1 {
      background-color: rgba(45, 181, 93, .15);
    }
    ...
    .shadow-level3 {
      --tw-shadow: 0px 1px 3px rgba(0, 0, 0, .04), 0px 6px 16px rgba(0, 0, 0, .12);
          ...
          <div class="mr-8 mt-6 flex min-w-[100px] justify-center">
            <div class="shrink-1 relative max-h-[100px] max-w-[100px] z-base">
              <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center">
                <div>
                  <div class="text-[24px] font-medium text-label-1 dark:text-dark-label-1">{{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 0).Count}}</div>
            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 1).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(index .SubmissionData.AllQuestionsCount 1).Count}}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
                      class="font-medium text-label-2 dark:text-dark-label-2">{{(index .SubmissionData.MatchedUser.ProblemsSolvedBeatsStats 0).Percentage}}%</span></span></div>
              </div>
              <div class="relative h-2 w-full overflow-hidden rounded-full h-1 max-w-none">
                ...
                <div
                  ...
                  style="width: {{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 1).Percentage}}%;"></div>
              </div>
            </div>
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 2).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(index .SubmissionData.AllQuestionsCount 2).Count}}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
                      class="font-medium text-label-2 dark:text-dark-label-2">{{(index .SubmissionData.MatchedUser.ProblemsSolvedBeatsStats 1).Percentage}}%</span></span></div>
              </div>
              <div class="relative h-2 w-full overflow-hidden rounded-full h-1 max-w-none">
                ...
                <div
                  ...
                  style="width: {{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 2).Percentage}}%;"></div>
              </div>
            </div>
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 3).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(index .SubmissionData.AllQuestionsCount 3).Count}}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
                      class="font-medium text-label-2 dark:text-dark-label-2">{{(index .SubmissionData.MatchedUser.ProblemsSolvedBeatsStats 2).Percentage}}%</span></span></div>
              </div>
              <div class="relative h-2 w-full overflow-hidden rounded-full h-1 max-w-none">
                ...
                <div
                  ...
                  style="width: {{(index .SubmissionData.MatchedUser.SubmitStatsGlobal.AcSubmissionNum 3).Percentage}}%;"></div>
              </div>
            </div>
          </div>
        </div>
