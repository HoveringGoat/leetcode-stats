          ...
          <div class="mr-8 mt-6 flex min-w-[100px] justify-center">
            <div class="shrink-1 relative max-h-[100px] max-w-[100px] z-base">
              <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform text-center">
                <div>
                  <div class="text-[24px] font-medium text-label-1 dark:text-dark-label-1">{{(acSubmissionNum[0].count).Count}}</div>
          ...
          <div class="flex w-full flex-col space-y-4 lc-xl:max-w-[228px]">
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(acSubmissionNum[1].count).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(acSubmissionNum[0].count).Count}}</span></div>
            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(acSubmissionNum[2].count).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(acSubmissionNum[2].count).Count}}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
            ...
            <div class="space-y-2">
              <div class="flex w-full items-end text-xs">
                ...
                <div class="flex flex-1 items-center"><span
                    class="mr-[5px] text-base font-medium leading-[20px] text-label-1 dark:text-dark-label-1">{{(acSubmissionNum[3].count).Count}}</span><span
                    class="text-xs font-medium text-label-4 dark:text-dark-label-4">/{{(acSubmissionNum[3].count).Count}}</span></div>
                <div class="lc-lg:hidden lc-xl:inline text-label-3 dark:text-dark-label-3"><span
                    class="space-x-1.5"><span>Beats</span><span
